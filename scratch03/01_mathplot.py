'''
matplot.pyplot 모듈을 사용한 데이터 시각화
...
# plot: 선 그래프 생성
plt.plot(years, gdp, c = 'g', marker = 'o')
...
print(histogram)    # 각 전수대별 시험 성적 갯수

plt.bar(histogram.keys(), histogram.values())
plt.yticks([0, 1, 2, 3, 4, 5])  # y 축 눈금 표시
plt.savefig('../image_output/year_gdp.png')
plt.show()
