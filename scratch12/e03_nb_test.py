...
# 집에 머물 확률: P(stay-home)
p_stay_home = 5 / 10  # P(stay-home) = 1 - P(go-out)    서로 배타적인 사건
...
# 외출했을 때 자동차가 정상인 경우: P(working|go-out)
p_working_when_go_out = 4 / 5

# 외출했을 때 자동차가 고장인 경우: P(broken|go-out)
p_broken_when_go_out = 1 / 5

# 집에 있을 때 맑을 확률: P(sunny|stay-home)
p_sunny_when_stay_home = 2 / 5

# 집에 있을 때 비가 올 확률: P(rainy|stay-home)
p_rainy_when_stay_home = 3 / 5

# 집에 있을 때 자동차가 정상인 경우: P(working|stay-home)
p_working_when_stay_home = 1 / 5

# 집에 있을 때 자동차가 고장인 경우: P(broken|stay-home)
p_broken_when_stay_home = 4 / 5

# 위쪽 까지는 과거의 데이터를 기반으로 이미 알고 있는 확률을 계산: 사전 확률

######################

# 만약 날씨가 맑고, 자동차가 정상이면 외출할 확률? 집에 있을 확률?
...
# P(X|A,B) ~ P(A|X) * P(B|X) * P(X) : Naive Bayes
...
# 날씨가 맑고 차가 정상일 때 외출 / 집에 있을 확률을 각각 계산하고,
# 둘 중 더 큰 값으로 예측한다. -> NB 머신 러닝


######################
print()

# 비가 오고 차가 고장일 때 외출을 할지 집에 있을지 예측
# 비가 오고 차가 고장일 때 외출을 할 확률
