...
if __name__ == '__main__':
    ...
    print(s)
    # NA를 평균 값을 대테하기 위해 평균 계산
    m = s.mean()    # numpy, pandas 의 깁계 함수들은 NA를 제거하고 계산
    print('평균 =', m)
    s = s.fillna(m) # Series s 의 모든 NA 들을 파라미터 m 으로 채워줌
    print(s)
    ...
    # GroupBy.apply(fn) 는 함수 fn의 첫번째 파라미터에 DataFrameGroupBy 객체를 전달
